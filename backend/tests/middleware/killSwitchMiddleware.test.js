...
describe('Kill Switch Enforcement Middleware', () => {
   ...
   */
  test('should attach kill switch utilities to request', () => {
    // Setup
   ...
   */
  test('should block action execution when globally disabled', () => {
   ...
   */
  test('should block actions for disabled tenant', () => {
   ...
   */
  test('should escalate all actions to human review in emergency mode', () => {
   ...
   */
  test('should disable learning system when ENABLE_INCIDENT_LEARNING=false', () => {
  ...
  describe('Bonus Coverage', () => {
    test('should allow action execution when all conditions pass', () => {
    ...
    test('should allow learning when enabled', () => {
      // Setup
    ...
    test('should block specific action types when restricted', () => {
    ...
    test('should allow specific action type when enabled', () => {
