...
function modelFor(
  ...
  if (
    ...
    throw Object.assign(
      new Error(
        `Unsupported legacy operational domain: ${domain}`
      ),
      {
        code:
          "LEGACY_OPERATIONAL_DOMAIN_UNSUPPORTED",
      }
    );
  }
...
class MongoLegacyOperationalRepository
...
module.exports =
  MongoLegacyOperationalRepository;