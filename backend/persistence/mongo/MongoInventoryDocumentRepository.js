...
function modelFor(
  ...
  if (!loader) {
    throw Object.assign(
      new Error(
        `Unsupported inventory operational domain: ${domain}`
      ),
      {
        code:
          "INVENTORY_OPERATIONAL_DOMAIN_UNSUPPORTED",
      }
    );
  }
...
class MongoInventoryDocumentRepository
...
module.exports =
  MongoInventoryDocumentRepository;