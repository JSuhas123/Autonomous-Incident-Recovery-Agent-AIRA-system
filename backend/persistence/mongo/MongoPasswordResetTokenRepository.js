...
const Contract = require("../repositories/PasswordResetTokenRepository");
const Model = require("../../models/PasswordResetToken");
const support = require("./MongoIdentityRepositorySupport");

class MongoPasswordResetTokenRepository extends Contract {
